...
const frutas = ["manzana", "Pera", "Uvas", "Platano"]

// Metodos son funciones que se ejecutan sobre un objeto

//Permite añadir nuevos elementos al final del Array
frutas.push('melocoton')
console.log(frutas)

//Permite eliminar el ultimo elemento del Array
frutas.pop()
console.log(frutas)

//Permite eliminar primer elemento del Array y devuelve lo que se elimino
frutas.shift()
console.log(frutas)

//Permite añadir nuevos elementos al principio del Array
